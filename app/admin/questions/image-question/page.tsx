...
import { ArrowLeft, Check, Upload, ImageIcon, Plus, Trash2, Circle, Square, CheckSquare } from "lucide-react"
...
export default function ImageQuestionEditorPage() {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <h1 className="text-lg sm:text-xl font-semibold text-foreground">Image Question Editor</h1>
              </div>
            </div>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="border-2 border-dashed border-muted-foreground/20 rounded-lg p-6 text-center hover:border-primary/50 transition-all">
                    {imageUrl ? (
                      <div className="space-y-2">
                        <img src={imageUrl} alt="Question" className="max-h-40 mx-auto rounded-lg" />
                        <Button variant="outline" size="sm" onClick={() => setImageUrl("")}>Remove</Button>
                      </div>
                    ) : (
                      <div className="space-y-2">
                  ...
                  <div key={option.id} className={`flex items-center gap-3 p-3 rounded-lg border-2 transition-all ${
                    ...
                    <button
                      ...
                      className={`w-8 h-8 rounded-full flex items-center justify-center transition-all ${
                        option.isCorrect ? "bg-green-500 text-white" : "bg-muted text-muted-foreground hover:bg-muted-foreground/20"
                      }`}
                    >
          ...
          <div className="lg:sticky lg:top-24 lg:self-start">
            <Card className="overflow-hidden">
              ...
              <CardContent className="p-6 space-y-6">
                ...
                {imageUrl ? (
                  <img src={imageUrl} alt="Question" className="w-full max-h-48 object-contain rounded-lg border" />
                ) : (
